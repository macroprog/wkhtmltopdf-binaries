...
This Repo contains the Windows (MSVC 2015) Binaries for Windows Vista or later; bundles VC++ Runtime 2013, and the Unix Binaries.
...
The binaries will then be located in the root folder:
    ...
    vendor/macroprog/wkhtmltopdf-binaries/
